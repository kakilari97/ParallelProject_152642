...
//							String password = br.readLine();
							...
							if (details != null) {
								...
								System.out.println("Enter the bank account number of receiver to transfer fund");
					...
					case 5:
						...
						//								long transId = Long.parseLong(br.readLine());
														//details = service.printTransaction(transId, details);
														details=service.printTransaction();
						//								if (service.printTransaction(transId, details) != null) {
						//									System.out.println("Transaction details " + details.getTransactionId());
						//									System.out.println("Receiver's Name: " + details.getDetails().getConsumerName());
